...
package com.susil.sonora.canvas
...
object SonoraCanvas {
    private const val DEFAULT_BASE_URL = "https://artwork-sonora.koiiverse.cloud/"
    ...
    fun initialize(
        ...
        this.baseUrl = baseUrl.trim().ifBlank { DEFAULT_BASE_URL }.let {
