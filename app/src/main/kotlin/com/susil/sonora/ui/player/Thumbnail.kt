...
import com.susil.sonora.canvas.CanvasArtwork
...
fun Thumbnail(
    ...
    val sonoraCanvasEnabled by rememberPreference(SonoraCanvasKey, false)
    ...
    LaunchedEffect(itemScrollOffset) {
        ...
        if (currentItem > currentMediaIndex && canSkipNext) {
            ...
            if (com.susil.sonora.ui.screens.settings.DiscordPresenceManager.isRunning()) {
                try { com.susil.sonora.ui.screens.settings.DiscordPresenceManager.restart() } catch (_: Exception) {}
            }
